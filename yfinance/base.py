...
class TickerBase():
    ...
    def _get_fundamentals(self, kind=None, proxy=None):
        ...
        # get fundamentals
        # data = utils.get_json(url+'/financials', proxy)  # バグ修正指示により変更
        url = "{}/{}/financials".format(self._scrape_url, self.ticker)  # バグ修正指示により追加
        data = utils.get_json(url, proxy)  # バグ修正指示により追加
